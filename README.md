...
- Backend:
  - Node.js
  - Express.js
  - PostgreSQL (It was used in a local environment, but it's not used in the production environment to save costs)
...
1. Clone the repository: github.com/fekimx/aws-cpp
